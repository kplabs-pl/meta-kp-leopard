...
- ``zynqmp-dram-test`` - builds ZynqMP DRAM Test executable used for validating DDR timings; refer to [README](./recipes-applications/zynqmp-dram-test/README.md) for more information on running it.
